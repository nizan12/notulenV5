...
import { Trash2, Plus, User as UserIcon, Edit, X, AlertTriangle, Loader2, FileSpreadsheet, Download, Upload, Info, ChevronDown, ChevronRight, Search, Filter, CheckSquare, Square, Minus } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
           ...
           <div className="flex gap-4 w-full md:w-auto items-center">
             ...
             <div className="relative w-full md:w-64">
                <select 
                  ...
                  className="w-full pl-3 pr-8 py-2 bg-white border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-primary outline-none appearance-none text-slate-900 cursor-pointer"
                >
              ...
              <tr>
                <th className="px-6 py-3 w-10">
                   <div className="flex items-center">
                     <input 
                       type="checkbox" 
                       className="w-4 h-4 rounded border-slate-300 text-blue-600 focus:ring-blue-500 cursor-pointer accent-[#2563EB]"
              ...
              {currentUsers.map((user) => (
                <tr key={user.id} className={`hover:bg-slate-50 transition-colors ${selectedIds.has(user.id!) ? 'bg-blue-50/50' : ''}`}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="h-10 w-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 mr-3 overflow-hidden border border-slate-200 shrink-0">
                ...
                <div>
                  ...
                  <div className="relative">
                    <select 
                      ...
                      className="w-full pl-3 pr-8 py-2 border border-slate-300 rounded-lg bg-white text-slate-900 focus:ring-2 focus:ring-primary outline-none appearance-none"
                      disabled={!!roleFilter}
                    >
      ...
      <Modal isOpen={isImportModalOpen} onClose={() => setIsImportModalOpen(false)}>
         {/* ... (Import Modal Content remains mostly same) ... */}
         <div className="p-6">
           <div className="flex justify-between items-center mb-4">
