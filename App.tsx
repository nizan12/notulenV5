              ...
              <div className="h-full min-h-[350px]">
                <BarChart data={adminStats.barData} title="Statistik Rapat per Unit" color="bg-blue-500" 
                   headerAction={<div className="flex gap-2">
                       <div className="relative">
                         <select value={statsMonth} onChange={(e) => setStatsMonth(e.target.value === 'all' ? 'all' : parseInt(e.target.value))} className="text-sm border-slate-300 rounded-xl shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 appearance-none px-3 py-1 pr-8 bg-white text-slate-900 border">
                       ...
                       <div className="relative">
                         <select value={statsYear} onChange={(e) => setStatsYear(parseInt(e.target.value))} className="text-sm border-slate-300 rounded-xl shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 appearance-none px-3 py-1 pr-8 bg-white text-slate-900 border">
